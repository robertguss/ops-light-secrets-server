...
const AES: &[(&str, &str, &str)] = &[
    (
        "ae1-kv-contract",
        "tests/api_kv.rs",
        "unsupported_surface_is_exact_enumerable",
    ),
    ("ae2-auth", "tests/auth.rs", "fn "),
    (
        "ae3-rotation-begin",
        "tests/rotation.rs",
        "begin_writes_no_secret",
    ),
    ...
    (
        "ae10-audit-fail-closed",
        "tests/transaction_coordinator.rs",
        "read_secret_is_not_released",
    ),
    (
        "ae11-adoption",
        "tests/rotation.rs",
        "adoption_status_classifies",
    ),
    ("ae12-capacity", "tests/capacity.rs", "fn "),
    (
        "ae13-closeout",
        "tests/rotation.rs",
        "rotation_complete_guard",
    ),
];
